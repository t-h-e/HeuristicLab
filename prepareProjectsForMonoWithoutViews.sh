...
if [[ "$unamestr" == 'Darwin' ]]; then
   ...
   mv tmp "HeuristicLab 3.3.sln"
    ...
    do
        sed "/$project/,+1d" "HeuristicLab 3.3.sln" > tmp
        mv tmp "HeuristicLab 3.3.sln"
    done;  
   sed -e '/HeuristicLab.Problems.ExternalEvaluation-3.4/,+1d' -e '/HeuristicLab.Problems.ExternalEvaluation.GP-3.5/,+1d' -e '/HeuristicLab.Problems.ExternalEvaluation.Matlab-3.3/,+1d' "HeuristicLab 3.3.sln" > tmp
   mv tmp "HeuristicLab 3.3.sln"
else 
